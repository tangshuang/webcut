...
import WebCutSelectZoom from './views/select-zoom/index.vue';
...
export {
    ...
    type WebCutProjectHistoryPatchOperation,
    type WebCutProjectHistoryPatch,
    type WebCutProjectHistoryData,
    type WebCutProjectHistoryPushPayload,
    type WebCutColors,
