export default {
  ...
  "1小时前": "1h ago",
  "分割片段": "Split Segment",
  "分割并保留左侧": "Split and Keep Left",
  "分割并保留右侧": "Split and Keep Right",
  "调整片段时长": "Adjust Segment Duration",
  "移动片段": "Move Segment",
  "批量添加素材": "Add Materials in Batch",
  "添加素材到轨道": "Add Material to Track",
  "添加文本素材": "Add Text Material",
  "调整滤镜": "Adjust Filter",
  "编辑文本": "Edit Text",
  "调整文本位置": "Adjust Text Position",
  "文本垂直居中": "Center Text Vertically",
  "文本贴底": "Align Text to Bottom",
  "调整动画": "Adjust Animation",
  "移除动画": "Remove Animation",
  "应用动画": "Apply Animation",
  "调整基础属性": "Adjust Basic Properties",
  "适配素材尺寸": "Fit Material Size",
  "素材居中": "Center Material",
  "调整音频音量": "Adjust Audio Volume",
  "调整视频音量": "Adjust Video Volume",
  "调整播放速度": "Adjust Playback Speed",
  ...
  "分辨率": "Resolution",
  "帧率": "FPS",
  "时间/帧切换": "Toggle time/frame",
  "视频比特率": "Video Bitrate",
  "编码格式": "Codec",
  "包含音频": "Include Audio",
  "关闭时将导出无声音的视频": "Will export video without sound when disabled",
  "音频比特率": "Audio Bitrate",
  "比特率": "Bitrate",
  "采样率": "Sample Rate",
  "导出中...": "Exporting...",
